...
let game = {
    ...
    buildings: [
        ...
        new Building('Private', 100, 1, [
            ...
            new Upgrade('Private II', 5000, 'Privates are twice as efficient', 20),
            new Upgrade('Private III', 15000, 'Privates are twice as efficient', 30),
            new Upgrade('Private IV', 50000, 'Privates are twice as efficient', 40),
            new Upgrade('Private V', 200000, 'Privates are twice as efficient', 50),
            new Upgrade('Private VI', 500000, 'Privates are twice as efficient', 75),
            new Upgrade('Private VII', 2500000, 'Privates are twice as efficient', 100),
            new Upgrade('Private VIII', 10000000, 'Privates are twice as efficient', 125),
            new Upgrade('Private IX', 35000000, 'Privates are twice as efficient', 150),
            new Upgrade('Private X', 92500000, 'Privates are twice as efficient', 175),
            new Upgrade('Private XI', 275000000, 'Privates are twice as efficient', 200),
        ...
        new Building('Commando', 250, 5, [
            ...
            new Upgrade('Commando II', 17500, 'Commandos are twice as efficient', 20),
            new Upgrade('Commando III', 60000, 'Commandos are twice as efficient', 30),
            new Upgrade('Commando IV', 300000, 'Commandos are twice as efficient', 40),
            new Upgrade('Commando V', 1000000, 'Commandos are twice as efficient', 50),
            new Upgrade('Commando VI', 4000000, 'Commandos are twice as efficient', 75),
            new Upgrade('Commando VII', 12500000, 'Commandos are twice as efficient', 100),
            new Upgrade('Commando VIII', 50000000, 'Commandos are twice as efficient', 125),
            new Upgrade('Commando IX', 250000000, 'Commandos are twice as efficient', 150),
            new Upgrade('Commando X', 750000000, 'Commandos are twice as efficient', 175),
            new Upgrade('Commando XI', 3000000000, 'Commandos are twice as efficient', 200)
        ]),
