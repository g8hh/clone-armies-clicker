...
let game = {
    ...
    buildings: [
        ...
        new Building('Cursor', 10, 0.1, [
            ...
            new Upgrade('Clicker VI', 500000, 'Mouse and clickers gain +1 blue coin for every non-clicker clone owned', 75, 1),
            new Upgrade('Clicker VII', 7500000, 'Mouse and clickers gain +5 blue coins for every non-clicker clone owned', 100, 5),
            new Upgrade('Clicker VIII', 100000000, 'Mouse and clickers gain +10 blue coins for every non-clicker clone owned', 125, 10),
            new Upgrade('Clicker IX', 1000000000, 'Mouse and clickers gain +25 blue coins for every non-clicker clone owned', 150, 25),
            new Upgrade('Clicker X', 25000000000, 'Mouse and clickers gain +100 blue coins for every non-clicker clone owned', 175, 100),
            new Upgrade('Clicker XI', 750000000000, 'Mouse and clickers gain +500 blue coins for every non-clicker clone owned', 200, 500),
            new Upgrade('Clicker XII', 5000000000000, 'Mouse and clickers gain +1,000 blue coins for every non-clicker clone owned', 225, 1000),
            new Upgrade('Clicker XIII', 100000000000000, 'Mouse and clickers gain +10,000 blue coins for every non-clicker clone owned', 250, 10000),
            new Upgrade('Clicker XIV', 5000000000000000, 'Mouse and clickers gain +100,000 blue coins for every non-clicker clone owned', 275, 100000),
            new Upgrade('Clicker XV', 350000000000000000, 'Mouse and clickers gain +1 million blue coins for every non-clicker clone owned', 300, 1000000),
            new Upgrade('Clicker XVI', 85000000000000000000, 'Mouse and clickers gain +100 million blue coins for every non-clicker clone owned', 350, 100000000),
            new Upgrade('Clicker XVII', 450000000000000000000000, 'Mouse and clickers gain +10 billion blue coins for every non-clicker clone owned', 400, 10000000000),
            new Upgrade('Clicker XVIII', 125000000000000000000000000, 'Mouse and clickers gain +1 trillion blue coins for every non-clicker clone owned', 450, 1000000000000),
            new Upgrade('Clicker XIX', 1e30, 'Mouse and clickers gain +100 trillion blue coins for every non-clicker clone owned', 500, 100000000000000),
            new Upgrade('Clicker XX', 1e36, 'Mouse and clickers gain +10 quadrillion blue coins for every non-clicker clone owned', 600, 10000000000000000)
        ], false),
